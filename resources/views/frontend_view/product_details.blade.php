...
<aside id="colorlib-hero" class="breadcrumbs">
		...
		<div class="colorlib-shop">
			<div class="container">
							...
							<div class="row">
								<div class="col-md-5">
									<div class="product-entry">
										<div class="product-img" style="background-image: url({{ asset('product_image/'.$single_product->product_image) }});">
											<p class="tag"><span class="sale">Sale</span></p>
										</div>
										<div class="thumb-nail">
											<a href="#" class="thumb-img" style="background-image: url({{ asset('product_image/'.$single_product->product_image) }});"></a>
											<a href="#" class="thumb-img" style="background-image: url({{ asset('product_image/'.$single_product->product_image) }});"></a>
											<a href="#" class="thumb-img" style="background-image: url({{ asset('product_image/'.$single_product->product_image) }});"></a>
										</div>
									</div>
								...
								<div class="col-md-7">
									<div class="desc">
                                     ...
                                     <p>{{ $single_product->product_details }}</p>										
										@if ($single_product->product_quantity >=1)
                                        <p><a href="{{ url('add/to/cart') }}/{{ $single_product->id }}" class="btn btn-primary btn-addtocart"><i class="icon-shopping-cart"></i> Add to Cart</a></p>
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="row">
							<div class="col-md-12 tabulation" style="margin-top: 50px">
		...
		<div class="colorlib-shop">
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading" style="margin-top: 40px">
				...
				<div class="row">
					...
					@foreach ($multi_product as $product)
